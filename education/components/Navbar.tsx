...
function Navbar() {
  return (
    ...
    <nav className=" max-w-6xl relative  rounded-full mx-auto  bg-slate-900 px-4 flex flex-wrap basis-full items-center justify-between ">
      <a className="sm:order-1 flex-none text-xl font-semibold ml-3 dark:text-white focus:outline-none focus:opacity-80" href="#">Brand</a>
