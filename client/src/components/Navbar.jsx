...
function Navbar() {
  return (
    ...
    <nav className=" max-w-6xl relative  rounded-full mx-auto  bg-slate-950 px-4 flex flex-wrap basis-full items-center justify-between ">
      <a className="sm:order-1 flex-none text-xl font-semibold ml-3 text-slate-400 focus:outline-none focus:opacity-80" href="#">EdTech</a>
      <div className="sm:order-3 flex items-center gap-x-2">
        ...
        <button type="button" className="py-2 px-3 my-5 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-700 dark:focus:bg-neutral-700">
          Login / Register
        </button>
      </div>
